...
typedef enum {
	...
	oPubkeyAcceptedKeyTypes, oCASignatureAlgorithms, oProxyJump, oOathKEY, oOathPasswd,
...
dump_client_config(Options *o, const char *host)
{
    ...
    dump_cfg_string(oOathPasswd, o->oathpasswd);
